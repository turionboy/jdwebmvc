...
public interface IBaseCoreMvcService {
	...
	/**
	 * 
	 * <br/>Description:判断请求地址是否包含在路由表内，有则返回对应的实体
	 ...
	 * @return
	 */
	public ConcurrentHashMap<String,Object> isRouteInfos(ConcurrentLinkedQueue<RouteInfo> routeInfos,String route,String methodType) throws Exception;

	/**
	 * 
	 * <br/>Description:根据参数执行对应的方法
	 * <p>Author:Eric Shi/史丙利</p>
	 * 
	 * @param routeInfo
	 * @param listenerBeans
